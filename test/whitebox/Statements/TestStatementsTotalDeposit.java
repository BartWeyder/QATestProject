...
public class TestStatementsTotalDeposit {
    ...
    public void test_1() {
        ...
        assertTrue(Math.abs(totalDeposit - 356.34) < 1e-2);
    }
    @Test
    public void test_2() {
    ...
    public void test_28() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 12951.86) < 1e-2);
    }
    @Test
    public void test_29() {
        calendar.set(2018, 0, 18);
