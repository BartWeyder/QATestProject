...
public class TestTriplesTotalDeposit {
    ...
    public void test_46() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 6.49) < 1e-2);
    }
    @Test
    public void test_47() {
        calendar.set(2018, 3, 30);
    ...
    public void test_48() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 46) < 1e-2);
    }
    @Test
    public void test_49() {
        calendar.set(2018, 1, 15);
    ...
    public void test_53() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 11.03) < 1e-2);
    }
    @Test
    public void test_54() {
        calendar.set(2018, 9, 30);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 12.83) < 1e-2);
    }
    @Test
    public void test_55() {
        calendar.set(2018, 1, 15);
    ...
    public void test_57() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 4.04) < 1e-2);
    }
    @Test
    public void test_58() {
        calendar.set(2018, 1, 16);
    ...
    public void test_59() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 17.83) < 1e-2);
    }
    @Test
    public void test_60() {
        calendar.set(2018, 9, 30);
    ...
    public void test_61() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 65.35) < 1e-2);
    }
    @Test
    public void test_62() {
        calendar.set(2018, 10, 1);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 35.99) < 1e-2);
    }
    @Test
    public void test_63() {
        calendar.set(2018, 1, 17);
    ...
    public void test_64() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 29.03) < 1e-2);
    }
    @Test
    public void test_65() {
        calendar.set(2018, 3, 30);
    ...
    public void test_66() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 48.99) < 1e-2);
    }
    @Test
    public void test_67() {
        calendar.set(2018, 1, 15);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 30.83) < 1e-2);
    }
    @Test
    public void test_68() {
        calendar.set(2018, 10, 1);
    ...
    public void test_69() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 90.34) < 1e-2);
    }
    @Test
    public void test_70() {
        calendar.set(2018, 1, 16);
    ...
    public void test_71() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 26.79) < 1e-2);
    }
    @Test
    public void test_72() {
        calendar.set(2018, 9, 30);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 64.35) < 1e-2);
    }
    @Test
    public void test_73() {
        calendar.set(2018, 1, 15);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 6.83) < 1e-2);
    }
    @Test
    public void test_74() {
        calendar.set(2018, 10, 1);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 8.63) < 1e-2);
    }
    @Test
    public void test_75() {
        calendar.set(2018, 1, 17);
    ...
    public void test_76() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 47.35) < 1e-2);
    }
    @Test
    public void test_77() {
        calendar.set(2018, 3, 30);
    ...
    public void test_78() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 7.04) < 1e-2);
    }
    @Test
    public void test_79() {
        calendar.set(2018, 1, 15);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.8) < 1e-2);
    }
    @Test
    public void test_80() {
        calendar.set(2018, 10, 1);
    ...
    public void test_82() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 5.69) < 1e-2);
    }
    @Test
    public void test_83() {
        calendar.set(2018, 3, 30);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 14.45) < 1e-2);
    }
    @Test
    public void test_84() {
        calendar.set(2018, 9, 30);
    ...
    public void test_88() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 67.34) < 1e-2);
    }
    @Test
    public void test_89() {
        calendar.set(2018, 1, 15);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 3.04) < 1e-2);
    }
    @Test
    public void test_90() {
        calendar.set(2018, 10, 1);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 7.83) < 1e-2);
    }
    @Test
    public void test_91() {
        calendar.set(2018, 1, 16);
    ...
    public void test_98() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 10.52) < 1e-2);
    }
    @Test
    public void test_99() {
        calendar.set(2018, 9, 30);
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 35.67) < 1e-2);
    }
    @Test
    public void test_100() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 77.02) < 1e-2);
    }
    @Test
    ...
    public void test_103() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 82.02) < 1e-2);
    }
    @Test
    ...
    public void test_106() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 20.71) < 1e-2);
    }
    @Test
    ...
    public void test_109() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 35.51) < 1e-2);
    }
    @Test
    public void test_110() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 8.72) < 1e-2);
    }
    @Test
    ...
    public void test_112() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 53.67) < 1e-2);
    }
    @Test
    ...
    public void test_115() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 31.47) < 1e-2);
    }
    @Test
    ...
    public void test_117() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 11.51) < 1e-2);
    }
    @Test
    public void test_118() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 9.52) < 1e-2);
    }
    @Test
    public void test_119() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 27.68) < 1e-2);
    }
    @Test
    ...
    public void test_121() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 8.6695) < 1e-2);
    }
    @Test
    public void test_122() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 10.8695) < 1e-2);
    }
    @Test
    public void test_123() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 19.6295) < 1e-2);
    }
    @Test
    ...
    public void test_130() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 9.5195) < 1e-2);
    }
    @Test
    ...
    public void test_133() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 10.71) < 1e-2);
    }
    @Test
    ...
    public void test_135() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 30.67) < 1e-2);
    }
    @Test
    ...
    public void test_137() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 10.15) < 1e-2);
    }
    @Test
    public void test_138() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 13.15) < 1e-2);
    }
    @Test
    public void test_139() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 23.11) < 1e-2);
    }
    @Test
    ...
    public void test_143() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 38.5) < 1e-2);
    }
    @Test
    public void test_144() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 72.86) < 1e-2);
    }
    @Test
    public void test_145() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 18.54) < 1e-2);
    }
    @Test
    ...
    public void test_148() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 24.04) < 1e-2);
    }
    @Test
    public void test_149() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 85.35) < 1e-2);
    }
    @Test
    ...
    public void test_151() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 13.85) < 1e-2);
    }
    @Test
    ...
    public void test_153() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 73.36) < 1e-2);
    }
    @Test
    public void test_154() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 56.5) < 1e-2);
    }
    @Test
    public void test_155() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 13.35) < 1e-2);
    }
    @Test
    ...
    public void test_158() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 31.51) < 1e-2);
    }
    @Test
    ...
    public void test_160() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 76.15) < 1e-2);
    }
    @Test
    public void test_161() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 11.05) < 1e-2);
    }
    @Test
    public void test_162() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 16.64) < 1e-2);
    }
    @Test
    public void test_163() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 34.8) < 1e-2);
    }
    @Test
    ...
    public void test_167() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 22.46) < 1e-2);
    }
    @Test
    public void test_168() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 54.01) < 1e-2);
    }
    @Test
    public void test_169() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 11.5) < 1e-2);
    }
    @Test
    ...
    public void test_175() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 21.11) < 1e-2);
    }
    @Test
    ...
    public void test_178() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.84) < 1e-2);
    }
    @Test
    public void test_179() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 31.01) < 1e-2);
    }
    @Test
    public void test_180() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 72.36) < 1e-2);
    }
    @Test
    public void test_181() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 12.275) < 1e-2);
    }
    @Test
    public void test_182() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.275) < 1e-2);
    }
    @Test
    public void test_183() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 25.235) < 1e-2);
    }
    @Test
    ...
    public void test_187() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 40.625) < 1e-2);
    }
    @Test
    public void test_188() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 81.975) < 1e-2);
    }
    @Test
    ...
    public void test_190() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 22.465) < 1e-2);
    }
    @Test
    ...
    public void test_193() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 28.34) < 1e-2);
    }
    @Test
    public void test_194() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 14.55) < 1e-2);
    }
    @Test
    public void test_195() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 87.85) < 1e-2);
    }
    @Test
    public void test_196() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 46.5) < 1e-2);
    }
    @Test
    ...
    public void test_198() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 26.54) < 1e-2);
    }
    @Test
    public void test_199() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 99.975) < 1e-2);
    }
    @Test
    ...
    public void test_201() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.475) < 1e-2);
    }
    @Test
    public void test_202() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 13.675) < 1e-2);
    }
    @Test
    ...
    public void test_207() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 36.8) < 1e-2);
    }
    @Test
    public void test_208() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 78.15) < 1e-2);
    }
    @Test
    ...
    public void test_210() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 13.05) < 1e-2);
    }
    @Test
    ...
    public void test_213() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 24.585) < 1e-2);
    }
    @Test
    public void test_214() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 56.135) < 1e-2);
    }
    @Test
    ...
    public void test_218() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 14.475) < 1e-2);
    }
    @Test
    public void test_219() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 23.235) < 1e-2);
    }
    @Test
    ...
    public void test_223() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 16.54) < 1e-2);
    }
    @Test
    public void test_224() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.35) < 1e-2);
    }
    @Test
    public void test_225() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 33.51) < 1e-2);
    }
    @Test
    ...
    public void test_227() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 12.9805) < 1e-2);
    }
    @Test
    public void test_228() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.9805) < 1e-2);
    }
    @Test
    public void test_229() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 25.9405) < 1e-2);
    }
    @Test
    ...
    public void test_232() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 23.1705) < 1e-2);
    }
    @Test
    public void test_233() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 41.3305) < 1e-2);
    }
    @Test
    public void test_234() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 82.6805) < 1e-2);
    }
    @Test
    ...
    public void test_238() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 27.3036) < 1e-2);
    }
    @Test
    public void test_239() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 76.6236) < 1e-2);
    }
    @Test
    public void test_240() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 47.2636) < 1e-2);
    }
    @Test
    public void test_241() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 29.1036) < 1e-2);
    }
    @Test
    public void test_242() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.3136) < 1e-2);
    }
    @Test
    ...
    public void test_245() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 16.1805) < 1e-2);
    }
    @Test
    public void test_246() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 39.3705) < 1e-2);
    }
    @Test
    public void test_247() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 75.6905) < 1e-2);
    }
    @Test
    public void test_248() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 34.3405) < 1e-2);
    }
    @Test
    public void test_249() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 41.1705) < 1e-2);
    }
    @Test
    public void test_250() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 78.814) < 1e-2);
    }
    @Test
    public void test_251() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 13.714) < 1e-2);
    }
    @Test
    public void test_252() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.514) < 1e-2);
    }
    @Test
    public void test_253() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 37.464) < 1e-2);
    }
    @Test
    ...
    public void test_255() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 33.674) < 1e-2);
    }
    @Test
    public void test_256() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 56.8405) < 1e-2);
    }
    @Test
    public void test_257() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 14.3305) < 1e-2);
    }
    @Test
    public void test_258() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 16.5305) < 1e-2);
    }
    @Test
    ...
    public void test_264() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 15.1805) < 1e-2);
    }
    @Test
    ...
    public void test_268() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 78.68) < 1e-2);
    }
    @Test
    public void test_269() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 14.38) < 1e-2);
    }
    @Test
    public void test_270() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 16.18) < 1e-2);
    }
    @Test
    public void test_271() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 35.86) < 1e-2);
    }
    @Test
    ...
    public void test_273() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 18.91) < 1e-2);
    }
    @Test
    ...
    public void test_278() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 33.09) < 1e-2);
    }
    @Test
    public void test_279() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 51.25) < 1e-2);
    }
    @Test
    public void test_280() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 92.6) < 1e-2);
    }
    @Test
    ...
    public void test_283() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 99.35) < 1e-2);
    }
    @Test
    public void test_284() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 46.01) < 1e-2);
    }
    @Test
    public void test_285() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 27.85) < 1e-2);
    }
    @Test
    public void test_286() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 26.05) < 1e-2);
    }
    @Test
    public void test_287() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 87.36) < 1e-2);
    }
    @Test
    public void test_288() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 58) < 1e-2);
    }
    @Test
    public void test_289() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 51.09) < 1e-2);
    }
    @Test
    ...
    public void test_291() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 110.6) < 1e-2);
    }
    @Test
    ...
    public void test_293() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 26.1) < 1e-2);
    }
    @Test
    ...
    public void test_295() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 46.8) < 1e-2);
    }
    @Test
    public void test_296() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 84.36) < 1e-2);
    }
    @Test
    public void test_297() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 26.84) < 1e-2);
    }
    @Test
    public void test_298() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 28.64) < 1e-2);
    }
    @Test
    public void test_299() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 23.05) < 1e-2);
    }
    @Test
    public void test_300() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 43.01) < 1e-2);
    }
    @Test
    public void test_301() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 35.21) < 1e-2);
    }
    @Test
    ...
    public void test_303() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 24.25) < 1e-2);
    }
    @Test
    public void test_304() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 26.45) < 1e-2);
    }
    @Test
    ...
    public void test_309() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 22.9) < 1e-2);
    }
    @Test
    public void test_310() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 25.1) < 1e-2);
    }
    @Test
    ...
    public void test_313() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 47.25) < 1e-2);
    }
    @Test
    ...
    public void test_315() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 27.29) < 1e-2);
    }
    @Test
    ...
    public void test_317() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 56.26) < 1e-2);
    }
    @Test
    ...
    public void test_322() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 113) < 1e-2);
    }
    @Test
    ...
    public void test_324() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 47) < 1e-2);
    }
    @Test
    public void test_325() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 71.65) < 1e-2);
    }
    @Test
    ...
    public void test_328() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 80.08) < 1e-2);
    }
    @Test
    ...
    public void test_330() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 43.64) < 1e-2);
    }
    @Test
    public void test_331() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 109.44) < 1e-2);
    }
    @Test
    public void test_332() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 68.09) < 1e-2);
    }
    @Test
    ...
    public void test_334() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 69.69) < 1e-2);
    }
    @Test
    public void test_335() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 106.01) < 1e-2);
    }
    @Test
    ...
    public void test_339() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 131) < 1e-2);
    }
    @Test
    public void test_340() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 41.35) < 1e-2);
    }
    @Test
    public void test_341() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 62.21) < 1e-2);
    }
    @Test
    public void test_342() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 107.35) < 1e-2);
    }
    @Test
    public void test_343() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 37.76) < 1e-2);
    }
    @Test
    public void test_344() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 103.56) < 1e-2);
    }
    @Test
    ...
    public void test_346() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 40.66) < 1e-2);
    }
    @Test
    ...
    public void test_348() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 87.16) < 1e-2);
    }
    @Test
    ...
    public void test_353() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 54.26) < 1e-2);
    }
    @Test
    ...
    public void test_358() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 43) < 1e-2);
    }
    @Test
    ...
    public void test_361() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 167.66) < 1e-2);
    }
    @Test
    ...
    public void test_363() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 184.61) < 1e-2);
    }
    @Test
    ...
    public void test_367() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 200) < 1e-2);
    }
    @Test
    public void test_368() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 241.35) < 1e-2);
    }
    @Test
    ...
    public void test_370() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 175.35) < 1e-2);
    }
    @Test
    ...
    public void test_373() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 194.35) < 1e-2);
    }
    @Test
    public void test_374() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 182.56) < 1e-2);
    }
    @Test
    public void test_375() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 260.35) < 1e-2);
    }
    @Test
    public void test_376() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 207.01) < 1e-2);
    }
    @Test
    ...
    public void test_378() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 194.55) < 1e-2);
    }
    @Test
    public void test_379() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 259.35) < 1e-2);
    }
    @Test
    ...
    public void test_381() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 174.85) < 1e-2);
    }
    @Test
    public void test_382() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 173.05) < 1e-2);
    }
    @Test
    public void test_383() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 234.36) < 1e-2);
    }
    @Test
    public void test_384() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 218) < 1e-2);
    }
    @Test
    ...
    public void test_386() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 158.36) < 1e-2);
    }
    @Test
    public void test_387() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 186.8) < 1e-2);
    }
    @Test
    public void test_388() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 224.36) < 1e-2);
    }
    @Test
    ...
    public void test_390() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 162.15) < 1e-2);
    }
    @Test
    public void test_391() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 169.01) < 1e-2);
    }
    @Test
    ...
    public void test_394() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 215.51) < 1e-2);
    }
    @Test
    ...
    public void test_403() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 171.55) < 1e-2);
    }
    @Test
    ...
    public void test_409() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 439.61) < 1e-2);
    }
    @Test
    ...
    public void test_412() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 430.35) < 1e-2);
    }
    @Test
    public void test_413() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 455) < 1e-2);
    }
    @Test
    public void test_414() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 496.35) < 1e-2);
    }
    @Test
    ...
    public void test_418() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 470.55) < 1e-2);
    }
    @Test
    public void test_419() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 524.36) < 1e-2);
    }
    @Test
    public void test_420() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 483.01) < 1e-2);
    }
    @Test
    public void test_421() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 470.35) < 1e-2);
    }
    @Test
    ...
    public void test_423() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 536.35) < 1e-2);
    }
    @Test
    ...
    public void test_425() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 429.85) < 1e-2);
    }
    @Test
    public void test_426() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 428.05) < 1e-2);
    }
    @Test
    public void test_427() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 514.35) < 1e-2);
    }
    @Test
    ...
    public void test_429() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 454.84) < 1e-2);
    }
    @Test
    ...
    public void test_432() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 402.15) < 1e-2);
    }
    @Test
    public void test_433() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 426.8) < 1e-2);
    }
    @Test
    public void test_434() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 402.35) < 1e-2);
    }
    @Test
    ...
    public void test_436() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 470.51) < 1e-2);
    }
    @Test
    ...
    public void test_439() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 438.96) < 1e-2);
    }
    @Test
    ...
    public void test_445() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 437.61) < 1e-2);
    }
    @Test
    ...
    public void test_448() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 492.35) < 1e-2);
    }
    @Test
    public void test_449() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 423.56) < 1e-2);
    }
    @Test
    public void test_450() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 423.36) < 1e-2);
    }
    @Test
    public void test_451() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 694.61) < 1e-2);
    }
    @Test
    ...
    public void test_453() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 677.66) < 1e-2);
    }
    @Test
    ...
    public void test_458() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 685.35) < 1e-2);
    }
    @Test
    public void test_459() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 710) < 1e-2);
    }
    @Test
    public void test_460() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 751.35) < 1e-2);
    }
    @Test
    ...
    public void test_463() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 812.35) < 1e-2);
    }
    @Test
    public void test_464() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 759.01) < 1e-2);
    }
    @Test
    ...
    public void test_466() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 734.56) < 1e-2);
    }
    @Test
    public void test_467() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 800.36) < 1e-2);
    }
    @Test
    ...
    public void test_469() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 709.84) < 1e-2);
    }
    @Test
    public void test_470() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 683.05) < 1e-2);
    }
    @Test
    public void test_471() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 769.35) < 1e-2);
    }
    @Test
    ...
    public void test_473() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 684.85) < 1e-2);
    }
    @Test
    public void test_474() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 708.04) < 1e-2);
    }
    @Test
    public void test_475() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 666.8) < 1e-2);
    }
    @Test
    public void test_476() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 704.36) < 1e-2);
    }
    @Test
    ...
    public void test_478() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 638.36) < 1e-2);
    }
    @Test
    public void test_479() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 642.15) < 1e-2);
    }
    @Test
    ...
    public void test_481() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 693.96) < 1e-2);
    }
    @Test
    ...
    public void test_483() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 679.01) < 1e-2);
    }
    @Test
    ...
    public void test_493() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 706) < 1e-2);
    }
    @Test
    public void test_494() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 744.36) < 1e-2);
    }
    @Test
    public void test_495() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 678.56) < 1e-2);
    }
    @Test
    ...
    public void test_497() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 695.46) < 1e-2);
    }
    @Test
    ...
    public void test_502() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 752.2) < 1e-2);
    }
    @Test
    ...
    public void test_504() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 686.2) < 1e-2);
    }
    @Test
    public void test_505() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 710.85) < 1e-2);
    }
    @Test
    ...
    public void test_508() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 771.92) < 1e-2);
    }
    @Test
    ...
    public void test_510() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 747.47) < 1e-2);
    }
    @Test
    public void test_511() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 813.27) < 1e-2);
    }
    @Test
    ...
    public void test_513() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 747.27) < 1e-2);
    }
    @Test
    public void test_514() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 708.89) < 1e-2);
    }
    @Test
    public void test_515() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 745.21) < 1e-2);
    }
    @Test
    ...
    public void test_517() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 685.7) < 1e-2);
    }
    @Test
    public void test_518() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 683.9) < 1e-2);
    }
    @Test
    ...
    public void test_521() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 663.81) < 1e-2);
    }
    @Test
    public void test_522() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 708.95) < 1e-2);
    }
    @Test
    public void test_523() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 643.15) < 1e-2);
    }
    @Test
    ...
    public void test_525() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 639.16) < 1e-2);
    }
    @Test
    public void test_526() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 679.86) < 1e-2);
    }
    @Test
    ...
    public void test_528() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 726.36) < 1e-2);
    }
    @Test
    ...
    public void test_533() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 693.46) < 1e-2);
    }
    @Test
    ...
    public void test_538() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 682.2) < 1e-2);
    }
    @Test
    public void test_539() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 703.86) < 1e-2);
    }
    @Test
    public void test_540() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 748.2) < 1e-2);
    }
    @Test
    ...
    public void test_542() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 40.21) < 1e-2);
    }
    @Test
    ...
    public void test_548() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 34.34) < 1e-2);
    }
    @Test
    public void test_549() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 448.01) < 1e-2);
    }
    @Test
    public void test_550() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 72.02) < 1e-2);
    }
    @Test
    public void test_551() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 77.85) < 1e-2);
    }
    @Test
    public void test_552() {
        ...
        double totalDeposit = new TotalDeposit(order).getTotalDeposit();
        System.out.println(totalDeposit);
        assertTrue(Math.abs(totalDeposit - 237.35) < 1e-2);
    }
    @Test
